...
class PrototypesControllerTest < ActionController::TestCase
  ...
  test "should create prototype" do
    assert_difference('Prototype.count') do
      post :create, prototype: { genre: @prototype.genre, github: @prototype.github, introduction: @prototype.introduction, title: @prototype.title, url: @prototype.url, user_id: @prototype.user_id }
    end
  ...
  test "should update prototype" do
    patch :update, id: @prototype, prototype: { genre: @prototype.genre, github: @prototype.github, introduction: @prototype.introduction, title: @prototype.title, url: @prototype.url, user_id: @prototype.user_id }
    assert_redirected_to prototype_path(assigns(:prototype))
  end
